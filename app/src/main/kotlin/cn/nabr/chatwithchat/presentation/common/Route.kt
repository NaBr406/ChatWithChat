...
object Route {
    ...
    const val CHAT_ROOM = "chat_room/{chatRoomId}?enabled={enabledPlatforms}&initialQuestion={initialQuestion}&initialModel={initialModel}&initialAttachments={initialAttachments}&initialRequestId={initialRequestId}"

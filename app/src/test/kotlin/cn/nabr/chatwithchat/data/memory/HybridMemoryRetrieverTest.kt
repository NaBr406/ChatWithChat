...
import cn.nabr.chatwithchat.data.memory.vector.MemoryVectorMatch
...
import cn.nabr.chatwithchat.di.MemoryRepositoryModule
...
class HybridMemoryRetrieverTest {
    ...
    fun `query time manifest mismatch discards vector results and requests repair`() = runBlocking {
        ...
        fixture.vectorStore.queryResult = MemoryVectorQueryResult.Unavailable(
            cn.nabr.chatwithchat.data.memory.vector.MemoryVectorUnavailableReason.STALE_MANIFEST
        )
